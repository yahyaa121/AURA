...
(16, 'Gaultier Divine', 'A radiant and feminine fragrance wrapped in a couture spirit. Orange blossom and bergamot sparkle at the top, leading into a heart of jasmine and solar notes. The base of vanilla and amber gives a sweet, warm finish. Elegant, luminous, and confident. Perfect for daytime glamour and sunny celebrations.', 'Un parfum féminin éclatant dans un flacon inspiré de la haute couture. Fleur d’oranger et bergamote ouvrent sur un cœur de jasmin et notes solaires. Le fond vanillé et ambré ajoute douceur et profondeur.', 120.00, 55, 'Female', 'Floral ', 'Floral ', 'All Year', 'Toute l\'année', '2025-05-15 18:00:00', 3),
(17, 'Scandal Le Parfum', 'A gourmand and floral masterpiece that blends innocence and sensuality. Gardenia and honey create a luminous opening, followed by orange blossom and jasmine. The caramel and patchouli base offers indulgence and mystery. Sweet, bold, and ultra-feminine. Ideal for fall evenings and elegant events.', 'Un gourmand floral ultra-féminin. Le miel et le gardénia ouvrent la fragrance, suivis par un cœur de jasmin et fleur d’oranger. Le fond de caramel et patchouli est sucré, enveloppant et très séduisant.', 115.00, 60, 'Female', 'Leather ', 'Cuir ', 'Fall, Winter', 'Automne, Hiver', '2025-05-15 18:00:00', 3),
(18, 'Le Male Elixir', 'An intense and spicy fragrance that redefines the classic Le Male style. Cinnamon and bergamot shine in the opening, leading to a heart of lavender and cardamom. The base is rich with vanilla, amber, and benzoin, creating a sweet and powerful trail. Deep, long-lasting, and seductive. A bold choice for cold weather.', 'Une interprétation riche et épicée du Le Male classique. La cannelle et la bergamote ouvrent sur un cœur aromatique de lavande et cardamome. Le fond chaleureux de vanille, ambre et benjoin assure une tenue longue et intense.', 130.00, 45, 'Male', 'Spicy', 'Épicé', 'Fall, Winter', 'Automne, Hiver', '2025-05-15 18:00:00', 3);
